            ...
            <Card className="bg-white/5 backdrop-blur-md border-white/10 rounded-3xl">
              <CardBody className="p-10">
                <div className="text-center mb-10">
                  <h2 className="text-3xl font-bold text-white mb-6">Your Music, Analyzed Beautifully</h2>
                  <p className="text-white/80 text-xl leading-relaxed max-w-3xl mx-auto">
                    ...
                    into your Spotify listening habits. Originally developed as an educational project, 
                    it has evolved into a comprehensive music analytics platform.
                  </p>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  {[
                    {
                      icon: (
                        <svg className="w-6 h-6 text-statfy-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                        </svg>
                      ),
                      title: "Privacy First",
                      description: "No data from your Spotify profile is stored on our servers. Your privacy is our priority."
                    },
                    {
                      icon: (
                        <svg className="w-6 h-6 text-statfy-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      title: "Fast & Modern",
                      description: "Built with modern React 18, Tailwind CSS, and HeroUI for optimal performance."
                    },
                    {
                      icon: (
                        <svg className="w-6 h-6 text-statfy-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      description: "Detailed insights into your listening habits with beautiful visualizations."
                    },
                    {
                      icon: (
                        <svg className="w-6 h-6 text-statfy-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="text-center">
                  ...
                  <div className="text-white/60 space-y-3">
                    ...
                    <div className="flex flex-wrap justify-center gap-3 text-sm">
                      {['React 18', 'TypeScript', 'Tailwind CSS', 'HeroUI', 'Framer Motion', 'Vite'].map((tech, index) => (
                        <span key={index} className="px-3 py-1 bg-white/10 rounded-full">{tech}</span>
                      ))}
                    </div>
                  </div>
                </div>
