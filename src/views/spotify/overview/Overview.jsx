...
function Overview() {
  ...
  const { data: topArtist, isLoading: artistIsLoading, hasError: artistError } = useDataHook(
    artistRequest,
  );
  const { data: topTrack, isLoading: trackisLoading, hasError: trackError } = useDataHook(
    trackRequest,
  );
