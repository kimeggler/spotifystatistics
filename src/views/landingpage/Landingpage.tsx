        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            {[
              ...
              <Card
                key={index}
                className="bg-white/5 backdrop-blur-md border-white/10 hover:bg-white/10 transition-all duration-300 rounded-2xl hover:scale-105 hover:-translate-y-2 hover:shadow-2xl hover:shadow-statfy-purple-500/20"
              >
