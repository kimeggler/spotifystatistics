    ...
    >
      <Card className="bg-red-500/10 border-red-500/20 max-w-md w-full rounded-3xl shadow-2xl backdrop-blur-md">
        <CardBody className="text-center p-10">
          ...
          <h2 className="text-white text-2xl font-black mb-4">Oops! Something went wrong</h2>
          <p className="text-white/80 mb-8 leading-relaxed">
            We encountered an unexpected error. Please try refreshing the page or check your
            connection.
          </p>
